...
ajouterContreVisite(idPrestationOrdinaires: number, adherantIds: number) {
  ...
  if (beneficiaireId !== null) {
    this.prestation_service.ajouterPrestationContreVisitePourBeneficiaireDentiste(
      this.user.id,
      ...
      (response) => {
        ...
        this.router.navigate(['/menu/dentc/ajoutPrestD']);
      },
      (error) => {
    ...
    this.prestation_service.ajouterPrestationContreVisite1PourDentiste(
      idPrestationOrdinaires,
      adherantIds,
      this.user.id,
      favore
      ...
      (response) => {
        console.log('Prestation ajoutée avec succès:', response);
        this.router.navigate(['/menu/prestationCOntreVisite']);
      },
      (error) => {
        console.error('Erreur lors de l\'ajout de la prestation:', error);
      }
